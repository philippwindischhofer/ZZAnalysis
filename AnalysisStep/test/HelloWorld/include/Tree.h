...
// Fri Mar  2 15:18:12 2018 by ROOT version 6.10/09
// from TTree candTree/Event Summary
// found on file: /data_CMS/cms/tsculac/CJLST_NTuples/ggH125/ZZ4lAnalysis.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data_CMS/cms/tsculac/CJLST_NTuples/ggH125/ZZ4lAnalysis.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data_CMS/cms/tsculac/CJLST_NTuples/ggH125/ZZ4lAnalysis.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/data_CMS/cms/tsculac/CJLST_NTuples/ggH125/ZZ4lAnalysis.root:/ZZTree");
