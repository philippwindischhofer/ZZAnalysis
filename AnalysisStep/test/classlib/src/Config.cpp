...
TString Config::source_label(TString histname)
{
	...
	{"ttH1lhist", "t#bar{t}H, t#bar{t} #rightarrow 1#font[12]{l} + X"},
	{"ttH2lhist", "t#bar{t}H, t#bar{t} #rightarrow 2#font[12]{l} + X"},
	{"bbHhist", "b#bar{b}H"},
	{"tqHhist", "tH"},
	{"qq4lhist", "q#bar{q} #rightarrow ZZ #rightarrow 4#font[12]{l}"},
	{"gg4lhist", "gg #rightarrow ZZ #rightarrow 4#font[12]{l}"},
	{"ZXhist", "Z + X"}
    };
