...
fChain->SetBranchAddress("D_VBF_ZHl_ML", &D_VBF_ZHl_ML, &b_D_VBF_ZHl_ML);
fChain->SetBranchAddress("D_VBF_WHl_ML", &D_VBF_WHl_ML, &b_D_VBF_WHl_ML);
fChain->SetBranchAddress("D_VBF_ZHMET_ML", &D_VBF_ZHMET_ML, &b_D_VBF_ZHMET_ML);
fChain->SetBranchAddress("D_VBF_ttHh_ML", &D_VBF_ttHh_ML, &b_D_VBF_ttHh_ML);
fChain->SetBranchAddress("D_VBF_ttHl_ML", &D_VBF_ttHl_ML, &b_D_VBF_ttHl_ML);
...
fChain->SetBranchAddress("D_WHh_ZHl_ML", &D_WHh_ZHl_ML, &b_D_WHh_ZHl_ML);
fChain->SetBranchAddress("D_WHh_WHl_ML", &D_WHh_WHl_ML, &b_D_WHh_WHl_ML);
fChain->SetBranchAddress("D_WHh_ZHMET_ML", &D_WHh_ZHMET_ML, &b_D_WHh_ZHMET_ML);
fChain->SetBranchAddress("D_WHh_ttHh_ML", &D_WHh_ttHh_ML, &b_D_WHh_ttHh_ML);
fChain->SetBranchAddress("D_WHh_ttHl_ML", &D_WHh_ttHl_ML, &b_D_WHh_ttHl_ML);
...
fChain->SetBranchAddress("D_ZHh_WHl_ML", &D_ZHh_WHl_ML, &b_D_ZHh_WHl_ML);
...
fChain->SetBranchAddress("D_ZHl_WHl_ML", &D_ZHl_WHl_ML, &b_D_ZHl_WHl_ML);
