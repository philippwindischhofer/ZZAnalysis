...
coll.add_model(no_preprocessor, mod)

train = Trainer("/home/llr/cms/wind/cmssw/CMSSW_9_4_2/src/ZZAnalysis/AnalysisStep/test/Python/training_logs/")

sgd = optimizers.SGD(lr = 0.1)
train.train(coll, optimizer = sgd)
