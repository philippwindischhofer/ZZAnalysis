...
class ModelFactoryFullCategorySetOptimizedInputs:
    ...
    def GenerateSimpleModelCollections(MC_path, weight_path = None):
        ...
        nonperiodic_columns_2j = ["JetPt[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|0]", "JetEta[JetPt|1]", 
        ...
        periodic_columns_2j = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "ZZPhi"]

        nonperiodic_columns_1j = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", 
                                  "D_VBF1j_ggH_ME",
                                  "ZZPt", "PFMET", "ZZMassErr", "Z1Mass", "Z2Mass", "ZZMass", "Z1Pt", "Z2Pt", "ZZEta", "nCleanedJetsPt30BTagged_bTagSF"]

        periodic_columns_1j = ["JetPhi[JetPt|0]", "ZZPhi"]

        nonperiodic_columns_0j = ["ZZPt", "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZMass",
        ...
        nonperiodic_columns = nonperiodic_columns_2j
        periodic_columns = periodic_columns_2j
        ...
        nonperiodic_columns = nonperiodic_columns_1j
        periodic_columns = periodic_columns_1j
        ...
        nonperiodic_columns = nonperiodic_columns_0j
        periodic_columns = periodic_columns_0j
