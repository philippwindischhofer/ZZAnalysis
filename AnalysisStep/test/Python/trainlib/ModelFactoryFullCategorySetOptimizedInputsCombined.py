...
class ModelFactoryFullCategorySetOptimizedInputsCombined:
    ...
    def GenerateSimpleModelCollections(MC_path, weight_path = None):
        ...
        # use a differential model for VBF-ggH discrimination, inclusive ones for all other pairings
        # ---------------------------------------------
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_VBF1j_ggH_ME", "D_WHh_ZHh_ME", "D_VBF2j_ggH_ME",
                               "PFMET", "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF", 
                               "ZZPt", "Z2Pt", "Z1Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZMassErr", "ZZMass", 
                               "nExtraLep"]
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_VBF1j_ggH_ME", "D_VBF2j_ggH_ME", "D_WHh_ZHh_ME", "D_VBF2j_ZHh_ME", "D_VBF2j_WHh_ME",
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_VBF1j_ggH_ME", "D_WHh_ggH_ME", "D_WHh_ZHh_ME", "D_ZHh_ggH_ME", "D_VBF2j_ggH_ME", "D_VBF2j_WHh_ME", "D_VBF2j_ZHh_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "JetPhi[JetPt|2]", "ExtraLepPhi[ExtraLepPt|0]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_VBF1j_ggH_ME", "D_ZHh_ggH_ME", "D_WHh_ggH_ME", "D_VBF2j_ZHh_ME", "D_VBF2j_ggH_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "JetPhi[JetPt|2]", "ExtraLepPhi[ExtraLepPt|0]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "JetPt[JetPt|3]", "JetEta[JetPt|3]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_WHh_ggH_ME", "D_VBF1j_ggH_ME", "D_ZHh_ggH_ME", "D_WHh_ZHh_ME", "D_VBF2j_ggH_ME", "D_VBF2j_ZHh_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_WHh_ggH_ME", "D_VBF1j_ggH_ME", "D_ZHh_ggH_ME", "D_VBF2j_ggH_ME", "D_VBF2j_ZHh_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "JetPhi[JetPt|2]", "ExtraLepPhi[ExtraLepPt|0]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_VBF1j_ggH_ME", "D_WHh_ggH_ME", "D_ZHh_ggH_ME", "D_VBF2j_ggH_ME", "D_WHh_ZHh_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "ExtraLepPhi[ExtraLepPt|0]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "ExtraLepPt[ExtraLepPt|0]",
                               "D_VBF1j_ggH_ME", "D_WHh_ggH_ME", "D_WHh_ZHh_ME", "D_ZHh_ggH_ME", "D_VBF2j_ggH_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "JetPt[JetPt|3]", "JetEta[JetPt|3]", "ExtraLepPt[ExtraLepPt|0]",
                               "D_VBF2j_ZHh_ME", "D_WHh_ggH_ME", "D_ZHh_ggH_ME", "D_WHh_ZHh_ME", "D_VBF1j_ggH_ME", "D_VBF2j_WHh_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "JetPt[JetPt|3]", "JetEta[JetPt|3]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_VBF1j_ggH_ME", "D_VBF2j_ZHh_ME", "D_VBF2j_WHh_ME", "D_ZHh_ggH_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "JetPhi[JetPt|2]", "JetPhi[JetPt|3]", "ExtraLepPhi[ExtraLepPt|0]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_VBF1j_ggH_ME", "D_VBF2j_ggH_ME", "D_ZHh_ggH_ME", "D_WHh_ggH_ME", 
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_VBF2j_ggH_ME", "D_VBF1j_ggH_ME", "D_ZHh_ggH_ME", "D_WHh_ZHh_ME", "D_WHh_ggH_ME", "D_VBF2j_WHh_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "JetPhi[JetPt|2]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_VBF1j_ggH_ME", "D_WHh_ZHh_ME", "D_WHh_ggH_ME", "D_ZHh_ggH_ME", "D_VBF2j_ggH_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_ZHh_ggH_ME", "D_VBF1j_ggH_ME", "D_WHh_ggH_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "JetPt[JetPt|3]", "JetEta[JetPt|3]", "ExtraLepPt[ExtraLepPt|0]",
                               "D_ZHh_ggH_ME", "D_WHh_ggH_ME", "D_VBF2j_ZHh_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "JetPhi[JetPt|2]", "JetPhi[JetPt|3]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "JetPt[JetPt|3]", "JetEta[JetPt|3]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepPt[ExtraLepPt|1]",
                               "D_VBF1j_ggH_ME", "D_WHh_ggH_ME", "D_VBF2j_ggH_ME", "D_VBF2j_WHh_ME", "D_WHh_ZHh_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "JetPhi[JetPt|2]", "JetPhi[JetPt|3]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]",
                               "D_VBF1j_ggH_ME", "D_VBF2j_ggH_ME", "D_VBF2j_ZHh_ME", "D_WHh_ZHh_ME", "D_WHh_ggH_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]",
                               "D_WHh_ZHh_ME", "D_VBF1j_ggH_ME", "D_WHh_ggH_ME", "D_ZHh_ggH_ME", "D_VBF2j_ggH_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "ExtraLepPt[ExtraLepPt|0]",
                               "D_WHh_ggH_ME", "D_VBF2j_ggH_ME", "D_ZHh_ggH_ME", "D_WHh_ZHh_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "JetPt[JetPt|3]", "JetEta[JetPt|3]", "ExtraLepPt[ExtraLepPt|0]",
                               "D_VBF1j_ggH_ME", "D_VBF2j_ggH_ME", "D_WHh_ZHh_ME", "D_ZHh_ggH_ME", "D_WHh_ggH_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "JetPt[JetPt|3]", "JetEta[JetPt|3]", "ExtraLepPt[ExtraLepPt|0]",
                               "D_WHh_ggH_ME", "D_VBF2j_ggH_ME", "D_ZHh_ggH_ME", "D_VBF1j_ggH_ME", "D_WHh_ZHh_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "JetPhi[JetPt|2]", "JetPhi[JetPt|3]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "JetPt[JetPt|3]", "JetEta[JetPt|3]", "ExtraLepPt[ExtraLepPt|0]",
                               "D_VBF2j_ggH_ME", "D_ZHh_ggH_ME", "D_WHh_ggH_ME", "D_VBF2j_ZHh_ME", "D_VBF2j_WHh_ME", "D_VBF1j_ggH_ME", "D_WHh_ZHh_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "JetPhi[JetPt|2]", "JetPhi[JetPt|3]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "JetPt[JetPt|3]", "JetEta[JetPt|3]", "ExtraLepPt[ExtraLepPt|0]",
                               "D_WHh_ggH_ME", "D_WHh_ZHh_ME", "D_VBF2j_ggH_ME", "D_VBF2j_WHh_ME", "D_VBF2j_ZHh_ME", "D_ZHh_ggH_ME", "D_VBF1j_ggH_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "JetPhi[JetPt|2]", "JetPhi[JetPt|3]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "JetPt[JetPt|3]", "JetEta[JetPt|3]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_ZHh_ggH_ME", "D_WHh_ZHh_ME", "D_WHh_ggH_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "JetPhi[JetPt|2]", "JetPhi[JetPt|3]", "ExtraLepPhi[ExtraLepPt|0]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_VBF1j_ggH_ME", "D_VBF2j_ggH_ME", "D_WHh_ggH_ME", "D_ZHh_ggH_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "JetPhi[JetPt|2]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "JetPt[JetPt|3]", "JetEta[JetPt|3]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_VBF2j_ggH_ME", "D_VBF1j_ggH_ME", "D_WHh_ggH_ME", "D_ZHh_ggH_ME", "D_VBF2j_WHh_ME", "D_VBF2j_ZHh_ME", "D_WHh_ZHh_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "JetPhi[JetPt|2]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
        ...
        nonperiodic_columns = ["JetPt[JetPt|0]", "JetEta[JetPt|0]", "JetPt[JetPt|1]", "JetEta[JetPt|1]", "JetPt[JetPt|2]", "JetEta[JetPt|2]", "JetPt[JetPt|3]", "JetEta[JetPt|3]", "ExtraLepPt[ExtraLepPt|0]", "ExtraLepEta[ExtraLepPt|0]",
                               "D_VBF2j_WHh_ME", "D_VBF1j_ggH_ME", "D_WHh_ggH_ME", "D_WHh_ZHh_ME", "D_VBF2j_ggH_ME", "D_VBF2j_ZHh_ME",
                               "PFMET", "Z1Pt", "Z2Pt", "ZZEta", "Z1Mass", "Z2Mass", "ZZPt", "ZZMassErr", "ZZMass", "nExtraLep",
                               "nCleanedJetsPt30", "nCleanedJetsPt30BTagged_bTagSF"]
        periodic_columns = ["JetPhi[JetPt|0]", "JetPhi[JetPt|1]", "JetPhi[JetPt|2]", "JetPhi[JetPt|3]", "ExtraLepPhi[ExtraLepPt|0]", "ZZPhi"]
        preprocessor_cuts = lambda row: row["ZZMass"] > 118. and row["ZZMass"] < 130.
