...
def generate_training_data(H1_files, H0_files, branches, preprocessor, training_split = 0.5, chunks = 1000):
    ...
    return datagen(H1_collection, H0_collection, branches, chunks = chunks, preprocessor = preprocessor)


def generate_validation_data(H1_files, H0_files, branches, preprocessor, training_split = 0.5, chunks = 1000):
...
def datagen(H1_collection, H0_collection, branches, preprocessor, chunks = 100):
    H1_curpos = 0
    H0_curpos = 0
    ...
    while True:
        ...
        input_data = training_data.loc[:, training_data.columns != "target"].as_matrix()
