...
class ModelFactoryFullCategorySetDynamic:
    ...
    def GenerateSimpleModelCollections(MC_path, weight_path = None):
        ...
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(VBF_cat, ggH_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(WHh_cat, ggH_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHh_cat, ggH_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(WHh_cat, ZHh_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(VBF_cat, WHh_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(VBF_cat, ZHh_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(WHl_cat, ggH_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(WHl_cat, VBF_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(WHl_cat, WHh_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(WHl_cat, ZHh_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(WHl_cat, ZHl_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(WHl_cat, ZHMET_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(WHl_cat, ttHh_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(WHl_cat, ttHl_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHh_cat, ZHl_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHh_cat, ZHMET_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHh_cat, ttHh_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHh_cat, ttHl_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHl_cat, ggH_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHl_cat, VBF_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHl_cat, WHh_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHl_cat, ZHMET_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHl_cat, ttHh_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHl_cat, ttHl_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHMET_cat, ggH_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHMET_cat, VBF_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHMET_cat, WHh_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHMET_cat, ttHh_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ZHMET_cat, ttHl_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ttHh_cat, ggH_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ttHh_cat, VBF_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ttHh_cat, WHh_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ttHh_cat, ttHl_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ttHl_cat, ggH_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ttHl_cat, VBF_cat)))
        mcolls.append(ModelCollection.from_discriminant_endpieces(*Category.match(ttHl_cat, WHh_cat)))
