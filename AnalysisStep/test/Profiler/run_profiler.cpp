...
int main(int argc, char *argv[])
{
    ...
    TString plot_name = "DVBF1j_ME";
    TString quantity = "DVBF1j_ME";
    ...
    make_plots1d(testclass, DVBF1j_ME_disc, number_bins, axis_lower, axis_upper, j1cut, category, quantity, y_label, category_name, normalize, plot_name, conf);
