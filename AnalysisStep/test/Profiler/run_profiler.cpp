...
int main(int argc, char *argv[])
{
    ...
    auto var = [&](Tree* in) -> float{return in -> D_ZHh_ggH_ME;};

    TString plot_name = "D_ZHh_ggH_ME";
    TString quantity = "D_ZHh_ggH_ME";
    ...
    //make_plot1d("VBFH125", new Routing(j2cut, "VBFhist"), var, number_bins, axis_lower, axis_upper, normalize, quantity, y_label, category_name, plot_name, conf);
